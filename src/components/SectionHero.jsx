	...
	const sectionItems = [
		{
			...
			paragraph:
				'With our teachers who write a program for each student, you will be able to makeyour first sketch after the first lesson.'
		}
	]
	return (
		<>
					...
					<div className='HeroSection' key={index}>
						<div className='content'>
							...
							<div className='wrapperButton'>
								<Button className='button' title={'Get started'} />
							</div>
						</div>
					</div>
				)
